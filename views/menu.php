<div id="menu">
	...
	<a class="btn_list <?php if( $page == "dashboard" ) { echo "green_active"; } ?> " href="?page=wpsm.dashboard">
		<i class="green-text fa fa-tachometer" aria-hidden="true"></i>
		<?php echo __( 'Dashboard', 'wpSlackManager' ); ?>
	</a>

	<a class="btn_list <?php if( $page == "users" ) { echo "red_active"; } ?> " href="?page=wpsm.users">
	...
	<p>Coming soon</p>
	<h4><?php echo __( 'Users', 'wpSlackManager' ); ?></h4>
	<p>Coming soon</p>
